    ...
    <div class="settings">
      ...
      <div class="col-md-6">
        <div class="acc-setting">
          ...
          <%--<div class="form-inline">
            <label for="exampleInputName2">Delete Reports</label> 
            <input value="" type="checkbox" id="Chkdelreports" name="Chkdelreports" onclick="Check_Click(this);" runat="server"/>      
          </div>--%>
<div class="form-inline">
      ...
      <div class="col-md-6">
        <div class="form-group form-btn pull-left">                      
            <%--<input id="Reset1" type="reset" value="Clear All" onclick="Clearuserinput();" class="btn btn-info btn-sm"/>--%>

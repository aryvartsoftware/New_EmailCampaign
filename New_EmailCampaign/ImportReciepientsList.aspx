...
<title>Import Contacts List :: Aryvart Campaign</title>
  ...
  <script src="js/bootstrap.min.js"></script>
    <script type ="text/javascript">
        ...
        ///Function clear all controls value of Form.
...
<body>
    ...
    <div class="form-group">
        ...
        <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" />
                    <b style="background-color:#ffff99;">(.xls, .xlsx)</b>
                </div> </div>--%>
         <div class="container-fluid">
    <div class="row">
      <div class="container">
    ...
    <div class="row">
      <div class="container new_campaign">
        <div class="row">
          ...
          <div class="col-md-12  new_bg import2"> <!-- start campaign section -->
            <div>
            ...
            <div class="row">
              <div class="col-md-8 import-list">                                      
                <div class="import">                      
                  ...
                  <p>Importing does not send any confirmation emails to your list. Make sure,<br> &#9658; Excel file should not contain empty row after column header.
                      <br>&#9658;The column in excel is described below,
                  </p>
              ...
              <div class="col-md-4">
                <div class="campaign import-file">                            
                    ...
                    <div class="form-group">
                     ...
                     <span></span>
                      <asp:FileUpload ID="FileUpload1" CssClass="form-control" runat="server" required="required" Font-Size="Small" />
                        <p>Acceptable file types: <b style="background-color:#ffff99;">(.xlsx, .xls)</b> &nbsp;&nbsp;&nbsp;                            
                            </p>  
                   ...
                   <%-- <div>
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"> Dynamic mapping
                        </label>
                      </div>
                    </div>   --%>              
                </div>
                ...
                <div class="map-field" id="mapcol" style="" > <!--display:none start campaign section  Map Your Fields -->
            ...
            <%--  <div class="form-group form-btn pull-right" style="padding-top: 16px;margin-right:16px;">
                  <label></label>

...
function ModalPopupWindow() {
    ...
    this.HideModalPopUp = function () {
        ...
        var rowdata = window.location.toString();
        if (rowdata.indexOf("CreateCampaignList.aspx") >= 0) {
            window.location.href = 'CreateCampaignList.aspx';
        }
        else if (rowdata.indexOf("ContactsView.aspx") >= 0) {
            window.location.href = 'ContactsView.aspx';
        }
        //else if ((rowdata.indexOf("/DCFForm.aspx") >= 0)) {
        //    window.location.href = 'DCFForm.aspx';
        //}
        //else if ((rowdata.indexOf("VA_DCFForm.aspx") >= 0)) {
        //    window.location.href = 'VA_DCFForm.aspx';
        //}
        //else if ((rowdata.indexOf("OrgChartView.aspx") >= 0)) {
        //    window.location.href = 'OrgChartView.aspx';
        //}
        //else if ((rowdata.indexOf("ViewCompanyUpload.aspx") >= 0)) {
        //    window.location.href = 'ViewCompanyUpload.aspx';
        //}
        //else if ((rowdata.indexOf("Depart_DCF.aspx") >= 0)) {
        //    window.location.href = 'Depart_DCF.aspx';
        //}
        //else if ((rowdata.indexOf("DepartIT_DCF.aspx") >= 0)) {
        //    window.location.href = 'DepartIT_DCF.aspx';
        //}
        var divFrameParent = document.getElementById("bailwal_div_frame_parent");
        var divOverlay = document.getElementById("bailwal_div_overlay");

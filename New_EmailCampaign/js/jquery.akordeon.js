(function ($) {
    $.fn.extend({
        ...
        akordeon: function (options) {
            var settings = $.extend({ expandedItem: 0, expandSpeed: 200, toggle: false, expandText: '<span class="glyphicon glyphicon-menu-down"></span>', collapseText: '<span class="glyphicon glyphicon-menu-right"></span>', buttons: true, hiddenItem: -1, itemsOrder: [] }, options);

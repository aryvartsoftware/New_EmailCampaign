                                    ...
                                    <asp:GridView ID="gvcampaign" runat="server" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Campaign Name" SortExpression="CampaignName">
                                                ...
                                                <HeaderStyle CssClass="grid-header03" Width="25%" />
                                            ...
                                            <asp:BoundField SortExpression="SentOn" DataFormatString="{0:MM/dd/yyyy}" DataField="SentOn" HeaderText="Sent On" HeaderStyle-CssClass="grid-header05" HeaderStyle-Width="13%" ItemStyle-CssClass="grid-item" ItemStyle-Width="13%" FooterStyle-CssClass="grid-item">
                                            ...
                                            <asp:BoundField SortExpression="Subscribers" DataField="Subscribers" HeaderText="Subscribers" HeaderStyle-CssClass="grid-header05" HeaderStyle-Width="15%" ItemStyle-CssClass="grid-item" ItemStyle-Width="15%" FooterStyle-CssClass="grid-item">

    ...
    <div class="settings users">
      <%--<div class="col-md-12 col-sm-12 col-xs-12">
        <h4>Users in <asp:Label ID="lblcompanyname" runat="server" Text=""></asp:Label><span class="list-delete pull-right">
             ...
             <a class="btn btn-default" href="InvitieUser.aspx" role="button">Plan Type</a> 
                     </span></h4>
      </div>--%>
      <div>
...
<tr>
<td>Is Single User: <asp:Image ID="imgEmployeeImage" runat="server" ImageUrl='<%# "~/images/Tick_inside_a_circle_24(1).png" %>' Visible = '<%# Eval("IsSingleUser").ToString() == "True" ? true : false %>' width="30px" height="30px"/></td>
<%--<td>Created Date:<asp:Label ID="lblDate" runat="server" Font-Bold="true" Text='<%#Eval("CreatedOn") %>'/></td>--%>
    <td><asp:Button ID="email" runat="server" Text="TRY THIS PLAN" CommandName="mail" OnClick = "Button_Click" CommandArgument = '<%# Eval("PK_PlanID") %>'  /></td>
</tr>
</table>
</td>
</tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MassUpdateContact.aspx.cs" Inherits="New_EmailCampaign.MassUpdateContact" %>
...
<body>
    ...
    <ContentTemplate>
               <p style="margin-top:-10px;padding: 0;"><asp:Label ID="lblcontact" CssClass="" runat="server" Text=""></asp:Label></p>

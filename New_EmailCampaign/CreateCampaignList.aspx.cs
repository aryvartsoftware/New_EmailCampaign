...
{
    public partial class CreateCampaignList : System.Web.UI.Page
    {
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:btndelete_Click() - " + ex.Message);
            }
        }
        protected void ddPageSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:ddPageSize_SelectedIndexChanged() - " + ex.Message);
            }
 ...
 if (lblPageCount != null)
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:gvcampaign_DataBound() - " + ex.Message);
            }
        }
        ...
        private void BindGrid()
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:BindGrid() - " + ex.Message);
            }
        }
        ...
        private void GenerateAlphabets()
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:GenerateAlphabets() - " + ex.Message);
            }
        }
        protected void Alphabet_Click(object sender, EventArgs e)
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:Alphabet_Click() - " + ex.Message);
            }
        }
        ...
        protected void gvcampaign_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:gvcampaign_PageIndexChanging() - " + ex.Message);
            }
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:Button2_Click() - " + ex.Message);
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                New_EmailCampaign.App_Code.GlobalFunction.StoreLog("CreateCampaignList.aspx:Button1_Click() - " + ex.Message);
            }
        }
